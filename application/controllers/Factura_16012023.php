		    ...
		    if(!empty($fac_id)){
		    	...
		    	while($n<$count_det){
		    		...
		    		if($this->input->post("pro_aux$n")!=''){
		    			...
		    			$det_Adicional = $this->input->post("det_Adicional$n");
...
public function buscar_cliente($txt){
    ...
    public function show_pdf($id,$opc_id,$correo,$etiqueta){
			...
			$dt_det=(object) array(
						...
						'ice_cod'=>$rst_dt->dfc_cod_ice,
						'precio_tot'=>$rst_dt->dfc_precio_total,
						'pro_detalle'=>$rst_dt->dfc_descripcion,
						);	
    ...
    //ENCABEZADO
        ...
        foreach ($detalle as $det) {
            ...
            if($det->dfc_descripcion!='' || $det->dfc_descripcion != null){
	            $xml.="<detallesAdicionales>" . chr(13);
	            $xml.="<detAdicional nombre='" . trim($det->mp_c) . "' valor='" . trim($det->dfc_descripcion) . "'/>". chr(13);
	            $xml.="</detallesAdicionales>" . chr(13);
            }
