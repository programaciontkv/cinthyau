                                ...
                                $cnt_detalle=0;
                                  ...
                                  ?>
                                    <tr>
                                        ...
                                        <td>
                                            <input style="text-align:left " type ="text" size="40" class="refer form-control"  id="pro_referencia" name="pro_referencia"   value="" lang="1" readonly style="width:250px;" />
                                         ...
                                         <td >
                                            <input style="text-align:left " type="text" style="width:300px;" size="40" class=" refer form-control" 
                                            id="det_Adicional" name="det_Adicional"  value="" lang="1"    />
                                        </td>
                                        <td>
            ...
            function clona_detalle(table,opc) {
                ...
                if (d == 0) {
                    ...
                    var fila = "<tr>"+
                                        ...
                                        "<td>"+
                                        "<input type ='text'   id='det_Adicional"+i+"' name='det_Adicional"+i+"'  lang='"+i+"' onchange='calculo()' class='form-control decimal' readonly value='"+det_Adicional.value+"' />"+
                                        "</td>"+
