            ...
            <form role="form" action="<?php echo $action?>" method="post" autocomplete="off">
              <div class="box-body">
                ...
                <div class="form-group <?php if(form_error('emi_cod_punto_emision')!=''){ echo 'has-error';}?> ">
                  ...
                  <input type="text" class="form-control numerico" id="emi_cod_punto_emision" name="emi_cod_punto_emision" value="<?php if(validation_errors()!=''){ echo set_value('emi_cod_punto_emision');}else{ echo $emisor->emi_cod_punto_emision;}?>">
                ...
                <label>Imagen:</label>
                      ...
                      <div class="form-group ">
                        <?php
                          if(validation_errors()==''){
                            $imagen2=$emisor->emi_logo;
                          }else{
                            $imagen2=set_value('emi_logo');
                          }
                        ?> 
                        <img id="fotografia" class="fotografia" src="<?php echo base_url().'imagenes/'.$emisor->emi_logo ?>" width="250px" height="200px" class="form-control">
                        <input type="text" hidden name="emi_logo" id="emi_logo" value="<?php if(validation_errors()!=''){ echo set_value('emi_logo');}else{ echo $emisor->emi_logo;}?>" >
            ...
            function uploadAjax() {
                ...
                $.ajax({
                    beforeSend: function () {
                      ...
                      if ($('#emi_cod_punto_emision').val().length == 0) {
                            //alert('Ingrese un codigo');
                            swal("Error!", "Ingrese un codigo de punto de emisión .!", "warning");
                            return false;
                        }
                    ...
                    url: base_url+"upload/subir_imagen/"+propiedad+"/"+emi_cod_punto_emision.value,
                    type: 'POST',
                    contentType: false,
                    data: data,
                    processData: false,
