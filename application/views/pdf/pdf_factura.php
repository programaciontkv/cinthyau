    ...
    <tr>
        <td>
            <table id="login">
                <tr>
                    <td>
                        <td><img src="<?php echo base_url().'imagenes/'.$factura->emi_logo?>" width="250px" height="100px"></td>
                    </td>
                </tr>    
            </table>
        </td>
            ...
            <table id="detalle" width="100%" class="table table-bordered table-list table-hover table-striped">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><?php echo ucfirst(strtolower($det->pro_detalle))?></td>
                ...
                <tbody>
                    <tr>
                        <td  colspan="4" rowspan="9" valign="top" style="background: #ffffff !important;">
                            <table id="info" >
                                <tr>
