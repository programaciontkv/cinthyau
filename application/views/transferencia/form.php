...
<section class="content">
                        ...
                        <table class="table">
                          ...
                          <tr>
                              ...
                              <div class="form-group <?php if(form_error('emi_nombre')!=''){ echo 'has-error';}?> ">
                                <input type="text" class="form-control" name="emi_nombre" id="emi_nombre" value="<?php if(validation_errors()!=''){ echo set_value('emi_nombre');}else{ echo $transferencia->emi_nombre;}?>" list='list_origen' onchange="traer_origen()">
                              ...
                              <div class="form-group <?php if(form_error('cli_nombre')!=''){ echo 'has-error';}?> ">
                                <input type="text" class="form-control" name="cli_nombre" id="cli_nombre" value="<?php if(validation_errors()!=''){ echo set_value('cli_nombre');}else{ echo $transferencia->cli_nombre;}?>" list='list_clientes' onchange="traer_destino()">
                                  <?php echo form_error("cli_nombre","<span class='help-block'>","</span>");?>
                                  <input type ="hidden" id="cli_id" name="cli_id" /></td>
      ...
      <?php 
        if(!empty($cns_destino)){
          foreach ($cns_destino as $rst_cli) {
      ?>
        <option value="<?php echo $rst_cli->emi_id?>"><?php echo $rst_cli->emi_nombre?></option>
      <?php 
          }
        }
      ?>
      ...
      function traer_origen(){
            ...
            function traer_destino(){
              $.ajax({
                    ...
                    url: base_url+"transferencia/traer_emisor/"+cli_nombre.value,
                    type: 'JSON',
                    dataType: 'JSON',
                    success: function (dt) {
                        if(dt!=""){
                          $('#cli_id').val(dt.emi_cod_cli);
                          $('#cli_nombre').val(dt.emi_nombre);
